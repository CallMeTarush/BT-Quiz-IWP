...
function nextQuestion() {
  ...
  if(getCounterValue() == 10) {
      ...
      if(window.location == "http://localhost:3000/evaluate/" + regno + "/management")
      {
      ...
      if(window.location == "http://localhost:3000/evaluate/" +  regno + "/design")
      {
      ...
      if(window.location == "http://localhost:3000/evaluate/" +  regno  + "/technical")
      {
      ...
      if(window.location == "http://localhost:3000/evaluate/" +  regno + "/advtechnical")
      {
